...
Product.create!(title: 'Docker for Rails Developers',
                description:
                  %{<p>
                    ...
                    setup tasks, replaced instead by a simple, consistent, Docker-based development environment that will ahve your team up and running in seconds.
                    Gain hands-on, real-world experience with a tool that's rapidly becoming
                    fundamental to software development. Go from zero all the way to production as Docker transforms that massive leap of deploying your app in the cloud
                    into a baby step.
                    </p>},
...
Product.create!(title: 'Build Chatbot Interactions',
                description:
                  %{<p>
                    ...
                    own natural language. Use free and open source tools along with Ruby to build creative, useful, and unexpected interactions
